...
We have implemented the environment for trailer trucks using pygame and gymnasium\cite{towers2024gymnasium}. We have tested the DQN algorithm to train the agent to back a trailer truck straight into a parking spot with constrained open spaces.
